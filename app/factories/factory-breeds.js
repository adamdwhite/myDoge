...
app.factory("breedSearchFactory", function($q, $http, FBCreds) {
    ...
    let getBreedNames = () => {
        return $q((resolve, reject) => {
            ...
            const getAllBreeds = (breeds, runningList) => {
                return $http.get(`https://dogbreed-characteristics.herokuapp.com/allBreeds`)

                // ***** This was the method to get all breeds by way of size, but the above URL will replace that
                // (`https://dogbreed-characteristics.herokuapp.com/characteristic/?characteristic=${size}`)
